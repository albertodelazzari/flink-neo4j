...
public class Neo4JSerializationMappingStrategyTest {
	...
	public void testMappingStrategy() {
		...
		Neo4JSerializationMappingStrategy<Tuple2<String, Integer>, SerializationMapperTest.TupleSerializationMapper> sourceMappingStrategy = new Neo4JSourceMappingStrategyTuple(
